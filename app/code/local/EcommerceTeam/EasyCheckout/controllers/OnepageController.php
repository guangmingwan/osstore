			...
			default:
				...
				if($billing_address_data = $this->getRequest()->getPost('billing')){
					...
					if (!$this->getOnepage()->getQuote()->isVirtual()) {
						...
						if($customerAddressId && !$as_billing){
						...
						}elseif(is_array($shipping_address_data) && !empty($shipping_address_data)){
	...
	public function saveAction(){
		...
		if ($this->getRequest()->isPost()) {
        	...
        	try {
				...
				$_result = $this->getOnepage()->saveBillingAddress($billing_data, $customerAddressId);
				...
				if (!$this->getOnepage()->getQuote()->isVirtual()) {
					...
					if(!$this->getOnepage()->getQuote()->getBillingAddress()->getUseForShipping()){
						...
						$_result = $this->getOnepage()->saveShippingAddress($this->getRequest()->getPost('shipping', array()), $customerAddressId);
