...
class Mage_Catalog_Block_Navigation extends Mage_Core_Block_Template
{
    ...
    public function drawleftsubmenuitem($category)
    {
    		$html = "";
        	...
        	foreach ($children as $child) {
	        	if ($child->getIsActive()) {
		            ...
		            $html.= '>'."\n";
		            $html.= '<a href="'.$this->getCategoryUrl($child).'">'.$this->htmlEscape($child->getName()). "</a>\n";
        		 }
        	}
	...
	public function drawleftmenuitem($category)
    {
        ...
        $html.= '<a href="'.$this->getCategoryUrl($category).'">'.$this->htmlEscape($category->getName()). "\n";
     	if ($hasChildren) {
            $cnt = 0;
            foreach ($children as $child) {
                if ($child->getIsActive()) {
        ...
        $htmlChildren = $this->drawleftsubmenuitem($category);
