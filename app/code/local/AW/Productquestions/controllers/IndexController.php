...
class AW_Productquestions_IndexController extends Mage_Core_Controller_Front_Action {
    ...
    public function indexAction() {
        ...
        $metaDescription = str_replace('%D', $this->_product->getName(), trim(preg_replace("/(\s){2,}/", ' ', Mage::getStoreConfig('productquestions/seo/header_meta_description_pattern'))));
    ...
    public function postAction() {
	 ...
	 $formId = 'product_question_form';
	$hasvalidateCapt = true;
	...
	if (!$captchaModel->isCorrect($captchaString) ) {
      ...
      $url = Mage::getUrl('productquestions/index', array('id' => $productId));
        ...
        if ($this->_product && !empty($data)) {
            ...
            if ($hasvalidateCapt && $validate === true) {
                ...
                try {
                    ...
                    if (Mage::getStoreConfig('productquestions/autorespond/status')) {
                        ...
                        $mailTemplate
                                ...
                                ->sendTransactional(
                                        Mage::getStoreConfig('productquestions/autorespond/email_template'), Mage::getStoreConfig(AW_Productquestions_Model_Source_Config_Path::EMAIL_SENDER), $data['question_author_email'], $data['question_author_name'], array(
                                    'data' => $question,
