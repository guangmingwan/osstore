...
class Halo_Category_Adminhtml_CategoryController extends Mage_Adminhtml_Controller_action
{
	...
	public function saveAction() {
		if ($data = $this->getRequest()->getPost()) {
			...
			try {
				...
				$model->save();
				Mage::getSingleton('adminhtml/session')->addSuccess(Mage::helper('category')->__('Item was successfully saved'));
    ...
    public function massStatusAction()
    {
        ...
        if(!is_array($categoryIds)) {
            ...
            try {
                foreach ($categoryIds as $categoryId) {
                    $category = Mage::getSingleton('category/category')
                        ->load($categoryId)
