 ...
 */
class MageAsia_LBTags_Block_Adminhtml_Tags_Edit_Tab_Related extends Mage_Adminhtml_Block_Widget_Grid
{
    ...
    public function __construct()
    {
        ...
        parent::__construct();
        $this->_currentTagModel = Mage::registry('tags_data');
        $this->setId('tags_assigned_product_grid');
        $this->setDefaultSort('entity_id');
        $this->setDefaultDir('DESC');
        $this->setUseAjax(true);
        
	 //	print_r($this->_currentTagModel); die("---");
